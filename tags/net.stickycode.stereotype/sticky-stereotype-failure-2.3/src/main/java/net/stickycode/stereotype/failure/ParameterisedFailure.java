...
public class ParameterisedFailure
    extends RuntimeException {

  public ParameterisedFailure(String message, Object... arguments) {
    super(ParameterResolver.resolve(message, arguments));
  }

  public ParameterisedFailure(Throwable t, String message, Object... arguments) {
