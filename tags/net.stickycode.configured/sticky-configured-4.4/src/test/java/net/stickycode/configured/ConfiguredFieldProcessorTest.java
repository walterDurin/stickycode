...
public class ConfiguredFieldProcessorTest {
  ...
  public void primitive() throws SecurityException, NoSuchFieldException {
    new ConfiguredFieldProcessor(processor, configuration, null).processField(this, getField("primitive"));
  }

  @Test
  public void processed() throws SecurityException, NoSuchFieldException {
    new ConfiguredFieldProcessor(processor, configuration, null).processField(this, getField("integer"));
