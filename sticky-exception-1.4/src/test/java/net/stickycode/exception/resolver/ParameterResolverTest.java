...
public class ParameterResolverTest {
  ...
  @Test
  public void split() {
    assertThat(ParameterResolver.split("")).containsExactly("");
    assertThat(ParameterResolver.split(" ")).containsExactly(" ");
    assertThat(ParameterResolver.split("{}")).hasSize(2);
    assertThat(ParameterResolver.split("{}{}")).hasSize(3);
    assertThat(ParameterResolver.split("{}{}")).containsExactly("", "", "");
    assertThat(ParameterResolver.split("a{}b{}c")).containsExactly("a", "b", "c");
    assertThat(ParameterResolver.split("a{}{}c")).containsExactly("a", "", "c");
    assertThat(ParameterResolver.split(" {} ")).containsExactly(" ", " ");
  }
